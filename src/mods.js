    ...
    return (
        <div className="row">
            <div className="col-sm mx-2">
                ...
                <rect width="50" height="50" rx="20" fill="#FF784B"/>
                ...
                <path d="M20.7017 21.2202V13.9558C20.7017 13.14 21.6258 12.6675 22.2871 13.1451L27.3163 16.7773C27.869 17.1764 27.869 17.9995 27.3163 18.3986L22.2872 22.0308C21.6258 22.5085 20.7017 22.0359 20.7017 21.2202Z" fill="white" stroke="#FF784B" stroke-width="1.6" stroke-linecap="round"/>
                </svg>
                <br />
...
export function Feature2(){
    return (
        ...
        <div className="row" >
            ...
            <div className="col-sm">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="50" height="50" rx="20" fill="#FEBB3A"/>
...
export function Feature3(){
    return (
        ...
        <div className="row">
            <div className="col-sm">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="50" height="50" rx="20" fill="#0048D5"/>
